...
This behavior pertains to the invoice, journal entry, refund receipt, and sales receipt tax line entries. Purchase tax lines should follow the same tax-account mapping pattern when enabled, rather than being associated with purchase expense accounts.
